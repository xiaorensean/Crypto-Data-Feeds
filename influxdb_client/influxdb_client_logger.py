...
# host name
HOST_log = "ec2-99-79-76-134.ca-central-1.compute.amazonaws.com"
# database name
database = 'md_rates'
...
class InfluxClient:
    ...
    def __init__(self):        
        ...
        self.client = InfluxDBClient(host=HOST_log, port=8086, username=user_name, password=passwords)
...
if __name__ == '__main__':
    ...
    a = db.query_tables('errorlog',['*',"where dbhost ='host2' and time > now() - 1m order by time limit 1000"])
    print(a.to_string())
    a.to_csv("error.csv")
    #print(a.to_string())
